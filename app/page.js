...
const slides = [
  { img: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=1200&q=80&auto=format&fit=crop', text: 'Find your perfect furry companion nearby' },
  { img: 'https://images.unsplash.com/photo-1560743641-3914f2c45636?w=1200&q=80&auto=format&fit=crop', text: 'Spend quality time with pets you love' },
  { img: 'https://images.unsplash.com/photo-1450778869180-41d0601e046e?w=1200&q=80&auto=format&fit=crop', text: 'Connect with pet owners in your city' },
  { img: 'https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=1200&q=80&auto=format&fit=crop', text: 'Every pet deserves love — including yours' },
]

const gridPhotos = [
  'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=500&q=80&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1518155317743-a8ff43ea6a5f?w=500&q=80&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1534361960057-19f4434d00c3?w=500&q=80&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1573865526739-10659fec78a5?w=500&q=80&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1444212477490-ca407925329e?w=500&q=80&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?w=500&q=80&auto=format&fit=crop',
]
...
const userTypes = [
  {
    icon: '🐾',
    title: 'Pet Lovers',
    desc: "Love animals but can't own one? Spend time with pets nearby and make furry friends without the full responsibility.",
    color: '#667eea',
  ...
  },
  {
    icon: '🏠',
    title: 'Pet Owners',
    desc: 'Share your pet\'s love and earn extra income. Set your schedule and meet verified animal lovers near you.',
    color: '#764ba2',
    img: 'https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=400&q=80&auto=format&fit=crop'
  },
  {
    icon: '🏥',
    title: 'NGOs & Vets',
    desc: 'Connect with the community. List your shelter or clinic and help animals in need find the care they deserve.',
    color: '#43b89c',
...
export default function Home() {
  ...
  return (
    <main style={{ fontFamily: "'Segoe UI', sans-serif", overflowX: 'hidden' }}>
      ...
      {/* Hero Slideshow */}
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', background: '#1a1a2e' }}>
        {slides.map((slide, i) => (
          <img
            key={i}
            src={slide.img}
        ...
        <div style={{
          ...
          <h1 style={{
            fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: '800', color: 'white',
          ...
          <p style={{
            fontSize: 'clamp(16px, 2.5vw, 22px)', color: 'rgba(255,255,255,0.92)',
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <button
              ...
              onMouseOver={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(102,126,234,0.6)' }}
              onMouseOut={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(102,126,234,0.5)' }}
            >
              Get Started Free 🐾
            </button>
            <button
              ...
              style={{
                padding: '16px 36px', background: 'rgba(255,255,255,0.15)',
                color: 'white', border: '2px solid rgba(255,255,255,0.8)',
                borderRadius: '50px', fontSize: '17px', fontWeight: '600',
                cursor: 'pointer', backdropFilter: 'blur(10px)',
                transition: 'transform 0.2s, background 0.2s'
              }}
              onMouseOver={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.background = 'rgba(255,255,255,0.25)' }}
        ...
        <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '1000px', margin: '0 auto' }}>
          {howItWorks.map((item) => (
            <div
              key={item.step}
              style={{
                background: 'white', borderRadius: '20px', padding: '40px 28px', width: '210px',
        ...
        <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '1000px', margin: '0 auto' }}>
          {userTypes.map((item) => (
            <div
              key={item.title}
              style={{
                background: 'white', borderRadius: '24px', overflow: 'hidden', width: '300px',
                boxShadow: '0 4px 24px rgba(0,0,0,0.08)', transition: 'transform 0.3s'
              }}
              onMouseOver={e => e.currentTarget.style.transform = 'translateY(-8px)'}
              onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'}
            >
              <img src={item.img} alt={item.title} style={{ width: '100%', height: '180px', objectFit: 'cover' }} loading="lazy" />
      ...
      <section style={{ position: 'relative', padding: '120px 20px', textAlign: 'center', overflow: 'hidden' }}>
        <img
          src="https://images.unsplash.com/photo-1415369629372-26f2fe60c467?w=1200&q=80&auto=format&fit=crop"
          alt="background"
          style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }}
        />
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(102,126,234,0.92), rgba(118,75,162,0.92))' }} />
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <button
            onClick={() => router.push('/onboarding')}
            style={{
              padding: '18px 48px', background: 'white', color: '#764ba2',
      ...
      <footer style={{ background: '#0f0f1a', color: '#aaa', padding: '60px 20px 40px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '32px' }}>
          {['About', 'How it works', 'For Owners', 'NGOs & Vets', 'Safety', 'Contact'].map(link => (
            <span
              key={link}
              style={{ cursor: 'pointer', fontSize: '14px', color: '#888', transition: 'color 0.2s' }}
